    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat24 = u_xlat24 * FGlobals._LightPositionRange.w;
    u_xlat24 = u_xlat24 * FGlobals._LightProjectionParams.w;
    u_xlat25 = _ShadowMapTexture.sample(sampler_ShadowMapTexture, u_xlat5.xyz).x;
    u_xlatb24 = u_xlat25<u_xlat24;
    u_xlat24 = (u_xlatb24) ? FGlobals._LightShadowData.x : 1.0;
    u_xlat21 = u_xlat21 + u_xlat24;
    u_xlat21 = clamp(u_xlat21, 0.0f, 1.0f);
    u_xlat23 = min(u_xlat21, u_xlat23);
    u_xlat21 = (u_xlatb22) ? u_xlat23 : u_xlat21;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    if(u_xlatb27){
        ...
        u_xlat27 = u_xlat27 * FGlobals._LightPositionRange.w;
        ...
        u_xlatb5 = (u_xlat6<float4(u_xlat27));
        u_xlat5.x = (u_xlatb5.x) ? FGlobals._LightShadowData.x : float(1.0);
        u_xlat5.y = (u_xlatb5.y) ? FGlobals._LightShadowData.x : float(1.0);
        u_xlat5.z = (u_xlatb5.z) ? FGlobals._LightShadowData.x : float(1.0);
        u_xlat5.w = (u_xlatb5.w) ? FGlobals._LightShadowData.x : float(1.0);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0 = u_xlat0 + FGlobals.unity_LightShadowBias.x;
    output.SV_Target0 = float4(u_xlat0) * FGlobals._LightPositionRange.wwww;
    return output;
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat4.x = u_xlat4.x * FGlobals._LightPositionRange.w;
    u_xlat4.x = u_xlat4.x * FGlobals._LightProjectionParams.w;
    u_xlatb1 = u_xlat1.x<u_xlat4.x;
    u_xlat1.x = (u_xlatb1) ? FGlobals._LightShadowData.x : 1.0;
    u_xlat4.xyz = input.TEXCOORD5.yyy * FGlobals.hlslcc_mtx4x4unity_WorldToLight[1].xyz;
    u_xlat4.xyz = fma(FGlobals.hlslcc_mtx4x4unity_WorldToLight[0].xyz, input.TEXCOORD5.xxx, u_xlat4.xyz);
    u_xlat4.xyz = fma(FGlobals.hlslcc_mtx4x4unity_WorldToLight[2].xyz, input.TEXCOORD5.zzz, u_xlat4.xyz);
    u_xlat4.xyz = u_xlat4.xyz + FGlobals.hlslcc_mtx4x4unity_WorldToLight[3].xyz;
